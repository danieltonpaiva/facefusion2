...
def render() -> None:
	...
	arquivos = [f for f in os.listdir('/content/facenico0/exemplos/') if os.path.isfile(os.path.join('/content/facenico0/exemplos/', f))]
	files = []
	for x in arquivos:
		files.append('/content/facenico0/exemplos/' + x)
