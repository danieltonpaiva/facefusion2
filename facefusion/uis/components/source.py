...
def render() -> None:
	...
	arquivos = [f for f in os.listdir('/content/facenico2/exemplos') if os.path.isfile(os.path.join('/content/facenico2/exemplos', f))]
	files = []
	for x in arquivos:
		files.append('/content/facenico2/exemplos' + x)
